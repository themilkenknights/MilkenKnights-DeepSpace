...
public class IntegrationTest {
		...
		@Test public void testSplineTrajectoryGenerator() {
				...
				List<Pose2d> waypoints = Arrays
						.asList(new Pose2d(0.0, 0.0, Rotation2d.fromDegrees(0.0)), new Pose2d(36.0, 0.0, Rotation2d.fromDegrees(0.0)), new Pose2d(60.0, 100, Rotation2d.fromDegrees(0.0)),
								new Pose2d(160.0, 100.0, Rotation2d.fromDegrees(0.0)), new Pose2d(200.0, 70, Rotation2d.fromDegrees(45.0)));
