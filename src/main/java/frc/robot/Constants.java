...
public final class Constants {
    ...
    /**
     * Every CAN ID should be listed here. Note that the Talons & Victors are physical numerical
     * order ony on the Comp Bot. Every CAN ID corresponds to the same outputs on the practice bot
    ...
    public static class VISION {
        ...
        static {
            VISION.kAreaToDistVisionMap
                .put(new InterpolatingDouble(12400.0), new InterpolatingDouble(15.9));
            VISION.kAreaToDistVisionMap
                .put(new InterpolatingDouble(9362.0), new InterpolatingDouble(20.16));
            VISION.kAreaToDistVisionMap
                .put(new InterpolatingDouble(6958.0), new InterpolatingDouble(26.26));
            VISION.kAreaToDistVisionMap
                .put(new InterpolatingDouble(5122.0), new InterpolatingDouble(32.45));
            VISION.kAreaToDistVisionMap
                .put(new InterpolatingDouble(3423.0), new InterpolatingDouble(42.8));
            VISION.kAreaToDistVisionMap
                .put(new InterpolatingDouble(2155.0), new InterpolatingDouble(57.44));
            VISION.kAreaToDistVisionMap
                .put(new InterpolatingDouble(1464.0), new InterpolatingDouble(73.35));
            VISION.kAreaToDistVisionMap
                .put(new InterpolatingDouble(980.0), new InterpolatingDouble(94.09));
        }
    }
        ...
        static {
            ...
            for (TalonLoc loc : kConfigs.keySet()) {
                ...
                if (loc == TalonLoc.Left || loc == TalonLoc.Right) {
                    ...
                    tal.remoteFilter0.remoteSensorSource =
