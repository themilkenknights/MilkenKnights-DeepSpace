...
/**
 * This class implements a PID Control Loop. <p> Does all computation synchronously (i.e. the
 * calculate() function must be called by the user from his own thread)
 */
