...
public class CollectAccelerationData implements Action {
	 ...
	 */
	public CollectAccelerationData(List<DriveCharacterization.AccelerationDataPoint> data,
			boolean reverse, boolean turn) {
	...
	public void update() {
		...
		double currentVelocity =
				(Math.abs(MkMath.InchesPerSecToUnitsPer100Ms(mDrive.mPeriodicIO.leftVel)) + Math
						.abs(MkMath.InchesPerSecToUnitsPer100Ms(mDrive.mPeriodicIO.rightVel))) / 4096.0
						* Math.PI * 10;
