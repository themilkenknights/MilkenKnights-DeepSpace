...
public class CollectAccelerationData implements Action {
    ...
    public void update() {
        ...
        double currentVelocity =
                (Math.abs(MkMath.InchesPerSecToUnitsPer100Ms(mDrive.mPeriodicIO.leftVel)) + Math.abs(MkMath.InchesPerSecToUnitsPer100Ms(mDrive.mPeriodicIO.rightVel))) / 4096.0
                        * Math.PI * 10;
        ...
        mAccelerationData.add(new DriveCharacterization.AccelerationDataPoint(currentVelocity, //convert to radians per second
