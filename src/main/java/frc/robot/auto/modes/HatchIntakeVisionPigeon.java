...
public class HatchIntakeVisionPigeon extends AutoModeBase {
  ...
  protected void routine() throws AutoModeEndedException {
    ...
    /*
     * runAction(new MotionMagicBlind(-30.0)); runAction(new
     * SetHatchArmState(HatchMechanismState.STOWED)); runAction(new
     * CargoArmSetpoint(CargoArmState.INTAKE)); runAction(new
     * SetSuperstructure(RobotState.TELEOP_DRIVE));
     */
  }
}
