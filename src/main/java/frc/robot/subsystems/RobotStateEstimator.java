...
public class RobotStateEstimator extends Subsystem {
	...
	private class EnabledLoop implements Loop {
		...
		public synchronized void onStart(double timestamp) {
			left_encoder_prev_distance_ = drive_.getLeftDist();
			right_encoder_prev_distance_ = drive_.getRightDist();

		}

		@Override
		public synchronized void onLoop(double timestamp) {
			final double left_distance = drive_.getLeftDist();
			final double right_distance = drive_.getLeftDist();
			...
			final Twist2d predicted_velocity = Kinematics.forwardKinematics(drive_.getLeftVel(),
					drive_.getRightVel());
