...
public class SubsystemManager {
     ...
     * Slow updates, telemetry, and safety checks should be run approx every 100ms. One subsystem
     * should update each cycle to extreme minimize delays. Vision updates should occur every 20ms
     * regardless of enabled state. While disbaled, run telemetry at 50hz (every 20ms) as there is
