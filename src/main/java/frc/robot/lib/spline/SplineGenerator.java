...
public class SplineGenerator {
	 ...
	 */
	public static List<Pose2dWithCurvature> parameterizeSpline(Spline s, double maxDx, double maxDy,
	...
	public static List<Pose2dWithCurvature> parameterizeSplines(List<? extends Spline> splines,
	...
	private static void getSegmentArc(Spline s, List<Pose2dWithCurvature> rv, double t0, double t1,
		...
		Pose2d transformation = new Pose2d(new Translation2d(p0, p1).rotateBy(r0.inverse()),
