...
public class LimeLight {
	 ...
	 * <p>
	 * kStandard - Side-by-side streams if a webcam is attached to Limelight kPiPMain - The secondary camera stream is placed in the lower-right corner of the primary
	 * camera stream kPiPSecondary - The primary camera stream is placed in the lower-right corner of the secondary camera stream
	 */
	...
	/**
	 * Limelight posts three raw contours to NetworkTables that are not influenced by your grouping mode. That is, they are filtered with your pipeline parameters, but
	 * never grouped. X and Y are returned in normalized screen space (-1 to 1) rather than degrees. *
	 */
