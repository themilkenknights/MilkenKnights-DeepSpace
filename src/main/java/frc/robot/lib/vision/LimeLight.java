...
public class LimeLight {
    ...
    NetworkTableEntry tv, tx, ty, ta, ts, tl, thoriz, tvert, ledMode, camMode, pipeline, stream,
        snapshot;
    ...
    public synchronized void updateTarget() {
        mTarget = new LimelightTarget(getIsTargetFound(), getX(), getY(), getHorizLength(),
            getVertLength(), getSkew_Rotation(), getCaptureTime());
     ...
     *
     * <p>
     * kStandard - Side-by-side streams if a webcam is attached to Limelight kPiPMain - The
