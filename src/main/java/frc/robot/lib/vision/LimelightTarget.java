...
public class LimelightTarget {
    ...
    public LimelightTarget(boolean validTarget, double xOffset, double yOffset, double horizLength,
        double vertLength, double skew, double captureTime) {
        ...
        this.distance =
            VISION.kAreaToDistVisionMap.getInterpolated(new InterpolatingDouble(getArea())).value;
        this.skew = skew + 45.0;
    }
    ...
    @Override public String toString() {
        return "X:" + xOffset + ", Y: " + yOffset + ", Area:" + area + ", Dt: " + captureTime
            + " Distance: " + distance + " Valid: " + validTarget;
    }
}
