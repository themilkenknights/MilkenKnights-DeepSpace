...
public class MkTalon {
  ...
  /**
   * Configures all Talon/Victor Configs at Startup based on the position This method is meant to contain all the mess in one place and ensure that
  ...
  public synchronized void resetConfig() {
    ...
    } else if (mSide == TalonLoc.Right_Drive) {
    ...
    } else if (mSide == TalonLoc.CargoIntake) {
    ...
    } else if (mSide == TalonLoc.CargoArm || mSide == TalonLoc.HatchArm) {
  ...
  /**
   * Return the expected error value for the current mode Note that the method returns the deviation from target setpoint unlike the official
   * getClosedLoopError() method. This method serves to limit CAN usage by using known setpoints to calculate error. TODO Verify getError() Method
   */
