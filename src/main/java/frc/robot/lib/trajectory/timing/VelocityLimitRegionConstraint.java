...
public class VelocityLimitRegionConstraint<S extends ITranslation2d<S>> implements
		TimingConstraint<S> {
	...
	public VelocityLimitRegionConstraint(Translation2d min_corner, Translation2d max_corner,
