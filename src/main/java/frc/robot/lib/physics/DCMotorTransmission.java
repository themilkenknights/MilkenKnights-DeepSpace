...
/**
 * Model of a DC motor rotating a shaft.  All parameters refer to the output (e.g. should already consider gearing and efficiency losses). The motor is assumed to be
...
public class DCMotorTransmission {
    ...
    public DCMotorTransmission(final double speed_per_volt, final double torque_per_volt, final double friction_voltage) {
