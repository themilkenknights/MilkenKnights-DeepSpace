...
public interface PixyLibrary extends Library {
  ...
  int pixy_cam_get_exposure_compensation(int uid, ByteByReference gain,
      ShortByReference compensation);
  ...
  int pixy_get_firmware_version(int uid, ShortByReference major, ShortByReference minor,
      ShortByReference build);
}
