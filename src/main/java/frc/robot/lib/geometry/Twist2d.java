...
/**
 * A movement along an arc at constant curvature and velocity. We can use ideas from "differential calculus" to create new RigidTransform2d's from a
 * Twist2d and visa versa.
 *
 * <p>
