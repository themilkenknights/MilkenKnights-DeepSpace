 ...
 * the &beta;<sub><em>i</em></sub> are the regression coefficients) that minimizes the sum of
 * squared residuals of the multiple regression model. It also computes associated the coefficient
 * of determination <em>R</em><sup>2</sup>.
 * <p>
