...
/**
 * InverseInterpolable is an interface used by an Interpolating Tree as the Key type. Given two endpoint keys and a third query key, an InverseInterpolable object can
 * calculate the interpolation parameter of the query key on the interval [0, 1].
 *
