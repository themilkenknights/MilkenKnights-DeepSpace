 ...
 * and functions get the instance of the drivetrain and act accordingly. Subsystems are also a state machine with a
 * desired state and actual state; the robot code will try to match the two states with actions. Each Subsystem also is
